...
if(isset($input->id)&&isset($input->mail)&&isset($input->client_id)&&isset($input->data)){
	$uuid=isset($input->id)?htmlentities(htmlspecialchars($input->id)):NULL; 
	$username=isset($input->mail)?htmlentities(htmlspecialchars($input->mail)):NULL; 
	$token=@htmlentities(htmlspecialchars($input->client_id));
	$data = $input->data;
	...
	//profile information
	$full_name=@htmlentities(htmlspecialchars($data->displayName));
	$last_name=@htmlentities(htmlspecialchars($data->surname));
	$first_name=@htmlentities(htmlspecialchars($data->givenName));
	$image=@htmlentities(htmlspecialchars(@$data->image));
	$department=@htmlentities(htmlspecialchars($data->department));
	$office=@htmlentities(htmlspecialchars($input->officeLocation));
	$position=@htmlentities(htmlspecialchars($input->jobTitle));
