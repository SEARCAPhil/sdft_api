...
function authenticate($db,$username,$password){
	...
	$sql='SELECT login_db_instance_1.accounts.account_username as username,login_db_instance_1.accounts.id,login_db_instance_1.sdft_sys_privilege.priv,login_db_instance_1.account_profile.profile_image,login_db_instance_1.account_profile.profile_name,login_db_instance_1.account_profile.profile_name,login_db_instance_1.account_profile.position,login_db_instance_1.account_profile.first_name,login_db_instance_1.account_profile.last_name,login_db_instance_1.account_profile.date_modified,login_db_instance_1.department.dept_name,login_db_instance_1.department.dept_id,login_db_instance_1.department.dept_alias FROM login_db_instance_1.accounts left join login_db_instance_1.account_profile on login_db_instance_1.account_profile.uid=accounts.id left JOIN login_db_instance_1.department on login_db_instance_1.department.dept_id=account_profile.dept_id left join login_db_instance_1.sdft_sys_privilege on login_db_instance_1.sdft_sys_privilege.uid=login_db_instance_1.accounts.id where login_db_instance_1.accounts.account_username=:username and login_db_instance_1.accounts.account_password=:password';
