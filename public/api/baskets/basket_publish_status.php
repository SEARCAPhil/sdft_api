...
if($status=='draft' || strlen($status)<1){
	$last_insert_id=$basket->update_status($db,$id,'draft');

	//log to database
	$activities->log_activity($db,$__identity->profile_id,$id,'Unpublished this basket');
