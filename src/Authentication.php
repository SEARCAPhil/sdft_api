...
class Authentication
{
	...
	function create_account_session($db,$uid,$profile_id,$uuid,$ip_address,$user_agent,$token){
		$sql="INSERT INTO account_session(uid,profile_id,uuid,ip_address,user_agent,token)values(:uid,:profile_id,:uuid,:ip_address,:user_agent,:token)";
		$sth=$db->prepare($sql);
